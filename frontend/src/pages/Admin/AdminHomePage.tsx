                ...
                <div className="w-330 mx-auto">
                    ...
                    <div className="flex items-center gap-4 mt-4">
                            <button onClick={() => location.href = '/admin/users'}
                                className="w-full relative rounded-xl h-12 bg-linear-to-r from-blue-600 to-cyan-500 text-white
                                ...
                                <span className="relative z-10">Просмотр пользователей</span>
                            </button>

                        <button onClick={() => location.href = '/admin/logs'} 
                            className="w-full relative rounded-xl h-12 bg-linear-to-r from-[#f2994a] to-[#f2c94c] text-white
                            font-bold text-base tracking-wide
                            cursor-pointer hover:scale-[1.02] active:scale-[0.98] transition-all duration-300
                            overflow-hidden group/btn">
                            <div className="absolute inset-0 w-full h-full bg-linear-to-r from-transparent via-white/20 to-transparent
                        ...
                        <button onClick={() => location.href = '/admin/audit-logs'} 
                            className="w-full relative rounded-xl h-12 bg-linear-to-r from-[#0033ff] to-[#977dff] text-white
                            font-bold text-base tracking-wide
                            cursor-pointer hover:scale-[1.02] active:scale-[0.98] transition-all duration-300
                            overflow-hidden group/btn">
                            <div className="absolute inset-0 w-full h-full bg-linear-to-r from-transparent via-white/20 to-transparent
                            ...
                            <span className="relative z-10">Просмотр аудита</span>
                        </button>

                        <button className="w-full relative rounded-xl h-12 bg-linear-to-r from-[#660f24] to-[#e5203a] text-white
                            font-bold text-base tracking-wide
                            cursor-pointer hover:scale-[1.02] active:scale-[0.98] transition-all duration-300
                            overflow-hidden group/btn">
                            <div className="absolute inset-0 w-full h-full bg-linear-to-r from-transparent via-white/20 to-transparent
